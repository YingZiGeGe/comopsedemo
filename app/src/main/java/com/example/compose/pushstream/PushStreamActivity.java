package com.example.compose.pushstream;
...
public class PushStreamActivity extends BaseActivity implements RtmpHandler.RtmpListener, SrsRecordHandler.SrsRecordListener, SrsEncodeHandler.SrsEncodeListener {
    ...
    private String rtmpUrl = "rtmp://192.168.1.102/zyy/mylive";
    ...
    private void requestPermission() {
        ...
        if (Build.VERSION.SDK_INT >= 23 &&
            ...
            //2. 权限没有开启，请求权限
            ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.CAMERA, Manifest.permission.RECORD_AUDIO, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE}, RC_CAMERA);
        } else {
            //权限已经开启，做相应事情
